...
//					tag
					sh "curl -i --user 'demo:abc123' -X POST 'http://www.demo.com:8081/service/rest/beta/tags/associate/jerry-1?repository=maven-dev&name=webgoat-server' --header 'Content-Type: application/json' --header 'Accept: application/json' "
				}
			}
		}
//
