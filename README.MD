...
Another way to deploy WebGoat and WebWolf in a more advanced way is to use a compose-file in a docker stack deploy.
...
This sets up an nginx webserver as a reverse proxy to WebGoat and WebWolf. You can change the timezone by adjusting the value in the .yaml file.
...
**Important**: The current directory on your host will be mapped to the container for keeping states.
