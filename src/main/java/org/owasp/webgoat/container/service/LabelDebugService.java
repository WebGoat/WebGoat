...
public class LabelDebugService {
   ...
   */
  @RequestMapping(path = URL_DEBUG_LABELS_MVC, produces = MediaType.APPLICATION_JSON_VALUE, method = RequestMethod.GET)
  ...
  @RequestMapping(
      ...
      params = KEY_ENABLED, method = RequestMethod.GET)
