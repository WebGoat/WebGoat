...
public class ImageServlet {
  ...
  public static final int PIN = new Random().nextInt(9000) + 1000;
  ...
  public byte[] logo() throws IOException {
    ...
    in[81216] = (byte) pin.charAt(0);
    in[81217] = (byte) pin.charAt(1);
    in[81218] = (byte) pin.charAt(2);
    in[81219] = (byte) pin.charAt(3);
