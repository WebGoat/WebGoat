...
@RestController
@AssignmentHints({
  "http-basics.hints.http_basic_form.1",
  "http-basics.hints.http_basic_form.2",
  "http-basics.hints.http_basic_form.3"
})
public class HttpBasicsForm implements AssignmentEndpoint {
